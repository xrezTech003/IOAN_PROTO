	...
	Properties
	{
		...
		SubShader
		{
			...
			Pass
			{
				...
				//Geometry Function
				[maxvertexcount(1)]
				void geom(point VertexOutput input[1], inout PointStream<g2f> output)
				{
					...
					o.uv = float2(0.5, 0.5);
					o.col = outColor;
					o.colMod = input[0].colMod;
					o.pos = mul(mul(UNITY_MATRIX_P, rand(float2(0, 1))), mIn);
