	...
	Properties
	{
		...
		SubShader
		{
			...
			VertexOutput vert(VertexInput v)
			{
				...
				float4 paramBits = float4(0, 0, 0, 0);
				...
				for (int i = 0; i < 8; i++)
				{
					...
					if (wavRad > 0)
					{
						...
						{
							int paramBool = 0;
							float4 tempBits = paramBits;

							switch (wavParam)
							{
								case 0: //RMS < 0.15
									if (v.uvB.x  * 0.6715103569670999 < 0.15)
										paramBool = 1;
									tempBits.x = 1;
									break;
								case 1: //SNR > 12
									if (v.uv.w * 26.61842977741538 > 12.0)
										paramBool = 1;
									tempBits.y = 1;
									break;
								case 2: //Highest Teff in the Grid
									//NOT IMPLEMENTED IN MESH
									tempBits.z = 1;
									break;
								case 3: //Variable Class 3 tier scores
									if (v.uvB.y == 1) //Possibly implemented poorly in Mesh
										paramBool = 1;
									tempBits.w = 1;
									break;
							}
				...
				float4 colorModOne = _paramColorMod0;
				float4 colorModTwo = _paramColorMod1;
				float4 colorModThree = _paramColorMod2;
				float4 colorModFour = _paramColorMod3;

				float colorNum = 0;
				float4 colorMod = float4(0, 0, 0, 0);

				if (paramBits.x == 1)
				{
					colorNum++;
					colorMod += colorModOne;
				}

				if (paramBits.y == 1)
				{
					colorNum++;
					colorMod += colorModTwo;
				}

				if (paramBits.z == 1)
				{
					colorNum++;
					colorMod += colorModThree;
				}

				if (paramBits.w == 1)
				{
					colorNum++;
					colorMod += colorModFour;
				}

				colorMod.a = 0.25;

				o.colMod = (colorNum > 0) ? colorMod / colorNum : colorMod;
			...
			void geom(point VertexOutput input[1], inout TriangleStream<g2f> output)
			{
				...
				float randScale0 = extensionScalar + (sin(_Time[1] * extensionOscFreq * rand(float2(baseColorVal, oscSize))) / 2.0 + 0.5) * extensionOscRange;
				float randScale1 = extensionScalar + (sin(_Time[1] * extensionOscFreq * rand(float2(baseColorHue, oscSize))) / 2.0 + 0.5) * extensionOscRange;
				float randScale2 = extensionScalar + (sin(_Time[1] * extensionOscFreq * rand(float2(baseColorSat, extensionScalar))) / 2.0 + 0.5) * extensionOscRange;
				float randScale3 = extensionScalar + (sin(_Time[1] * extensionOscFreq * rand(float2(baseColorVal, extensionOscRange))) / 2.0 + 0.5) * extensionOscRange;
				float randScale4 = extensionScalar + (sin(_Time[1] * extensionOscFreq * rand(float2(baseColorHue, baseSize))) / 2.0 + 0.5) * extensionOscRange;
				float randScale5 = extensionScalar + (sin(_Time[1] * extensionOscFreq * rand(float2(baseColorSat, oscSize))) / 2.0 + 0.5) * extensionOscRange;
				float randScale6 = extensionScalar + (sin(_Time[1] * extensionOscFreq * rand(float2(baseColorVal, extensionScalar))) / 2.0 + 0.5) * extensionOscRange;
				float randScale7 = extensionScalar + (sin(_Time[1] * extensionOscFreq * rand(float2(baseColorHue, extensionOscRange))) / 2.0 + 0.5) * extensionOscRange;
				float randScale8 = extensionScalar + (sin(_Time[1] * extensionOscFreq * rand(float2(baseColorSat, baseSize))) / 2.0 + 0.5) * extensionOscRange;
				float randScale9 = extensionScalar + (sin(_Time[1] * extensionOscFreq * rand(float2(baseColorVal, oscSize))) / 2.0 + 0.5) * extensionOscRange;
				float randScale10 = extensionScalar + (sin(_Time[1] * extensionOscFreq * rand(float2(baseColorHue, baseColorVal))) / 2.0 + 0.5) * extensionOscRange;
				float randScale11 = extensionScalar + (sin(_Time[1] * extensionOscFreq * rand(float2(baseColorSat, baseColorVal))) / 2.0 + 0.5) * extensionOscRange;
				...
				float scale0 = (1.0 + (rand(input[0].oldPos.xz)                    * randScale0))  * baseScale;
				float scale1 = (1.0 + (rand(input[0].oldPos.xy)                    * randScale1))  * baseScale;
				float scale2 = (1.0 + (rand(input[0].oldPos.yz)                    * randScale2))  * baseScale;
				float scale3 = (1.0 + (rand(input[0].uv.xy)                        * randScale3))  * baseScale;
				float scale4 = (1.0 + (rand(input[0].uv.xz)                        * randScale4))  * baseScale;
				float scale5 = (1.0 + (rand(input[0].uv.yz)                        * randScale5))  * baseScale;
				float scale6 = (1.0 + (rand(input[0].uv.xw)                        * randScale6))  * baseScale;
				float scale7 = (1.0 + (rand(input[0].uv.yw)                        * randScale7))  * baseScale;
				float scale8 = (1.0 + (rand(input[0].uvB.xy)                       * randScale8))  * baseScale;
				float scale9 = (1.0 + (rand(input[0].uvB.xz)                       * randScale9))  * baseScale;
				float scale10 = (1.0 + (rand(input[0].uvB.yz)                       * randScale10)) * baseScale;
				float scale11 = (1.0 + (rand(float2(input[0].uvB.x, input[0].uv.x)) * randScale11)) * baseScale;

				//Set Mesh Values
				float3 VERTICES[12] = { float3(0, -0.525731,  0.850651) * scale0,
										float3(0.850651,         0,  0.525731) * scale1,
										float3 (0.850651,         0, -0.525731) * scale2,
										float3(-0.850651,         0, -0.525731) * scale3,
										float3(-0.850651,         0,  0.525731) * scale4,
										float3(-0.525731,  0.850651,         0) * scale5,
										float3(0.525731,  0.850651,         0) * scale6,
										float3(0.525731, -0.850651,         0) * scale7,
										float3(-0.525731, -0.850651,         0) * scale8,
										float3(0, -0.525731, -0.850651) * scale9,
										float3(0,  0.525731, -0.850651) * scale10,
										float3(0,  0.525731,  0.850651) * scale11 };
