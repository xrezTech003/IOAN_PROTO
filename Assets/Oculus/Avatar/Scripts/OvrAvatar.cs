...
#endif
                ///<remarks>Nathaniel has commented this line out because it throws 100 errors and it's all related to spatializer and mic settings we will not be using + everything works without it</remarks>
                //InitPostLoad(); //TODO: DEGUB NDH
                assetsFinishedLoading = true;
